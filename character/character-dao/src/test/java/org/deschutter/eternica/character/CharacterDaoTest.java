...
public class CharacterDaoTest {
    ...
    public void testFindByUserEntityId() throws Exception {
        ...
        CharacterEntity character = characterDao.save(new CharacterEntity(userEntity, "Character1", raceDao.save(new RaceEntity("RaceName1"))));
        CharacterEntity character2 = characterDao.save(new CharacterEntity(userEntity, "Character2", raceDao.save(new RaceEntity("RaceName1"))));
    ...
    @Test
    public void findOne () {
        CharacterEntity character = characterDao.save(new CharacterEntity(userDao.save(new UserEntity("username", "password")), "Character1", raceDao.save(new RaceEntity("RaceName1"))));
